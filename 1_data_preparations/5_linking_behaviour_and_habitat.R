## load gps.behav.data
gps.behav.data <- read.csv('data/raw/gps.behav.data.csv')
gps.behav.data$datetime_CEST <- ymd_hms(gps.behav.data$datetime_CEST, tz='Europe/Amsterdam')
...
chick.parent.data.behav$year = year(chick.parent.data.behav$datetime.chick)
ydays.bird = unique(chick.parent.data.behav[,c('birdID.parent','birdID.chick','yday','year')])
